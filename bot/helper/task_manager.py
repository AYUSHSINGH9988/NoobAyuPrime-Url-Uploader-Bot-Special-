...
# ── Video Tools sessions ──────────────────────────────────────────────────────

# msg_id -> {uid, chat_id, rep_msg_id}
# Used by /vt command interactive menu (file not yet downloaded)
vt_sessions: dict = {}

# msg_id -> {uid, fp, dl_dir, target_chat, user_name}
# Used by -vt flag: file already downloaded, waiting for action selection
vt_download_sessions: dict = {}

# user_id -> {video_fp, dl_dir, msg, action, target_chat, user_name}
# Waiting for user to send second file for merge operations
waiting_for_vt_merge: dict = {}
